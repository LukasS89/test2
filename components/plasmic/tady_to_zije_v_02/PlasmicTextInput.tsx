...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 07htI-B8VH1o/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__fuy0O)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__ecSqb)}
              role={"img"}
            />
          ),
