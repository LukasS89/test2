...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: uOXSGjdx3eNE/css
  ...
  return (
    ...
    >
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__af6De)}
      >
        <BaseText
