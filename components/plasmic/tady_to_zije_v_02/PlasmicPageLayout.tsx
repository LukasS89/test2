...
import sty from "./PlasmicPageLayout.module.css"; // plasmic-import: EPKK2oVRsr9Z/css

import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: hPs_YJGbsfDu/icon
import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: MlVV28eg4dbe/icon
...
function PlasmicPageLayout__RenderFunc(props: {
  ...
  return (
    <RichLayout
      ...
      logoElement={
        <Icon2Icon
          className={classNames(projectcss.all, sty.svg__mtUaB)}
          role={"img"}
        />
      }
      menu={(() => {
    ...
    >
      <LoadingBoundary
        ...
        loadingState={
          <DataCtxReader__>
            {$ctx => (
              <div className={classNames(projectcss.all, sty.freeBox__xoaGv)}>
                <IconIcon
                  className={classNames(projectcss.all, sty.svg__bwE7T)}
                  role={"img"}
                />
              </div>
            )}
      ...
      >
        <DataCtxReader__>
          {$ctx => (
            <div className={classNames(projectcss.all, sty.freeBox___7AssN)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <section
                    className={classNames(projectcss.all, sty.section__g7WY)}
                  >
                    <h1
                      className={classNames(
                        projectcss.all,
