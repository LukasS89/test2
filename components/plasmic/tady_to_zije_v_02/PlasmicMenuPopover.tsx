...
import sty from "./PlasmicMenuPopover.module.css"; // plasmic-import: kd7ahv1K0Lgk/css
            ...
            {renderPlasmicSlot({
              defaultContents: (
                <React.Fragment>
                  ...
                  <MenuItem
                    className={classNames("__wab_instance", sty.menuItem__cQlF)}
                    label={"Item 2"}
                    value={"item2"}
                  />
