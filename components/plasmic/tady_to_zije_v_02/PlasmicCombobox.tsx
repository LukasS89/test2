...
import Label from "../../Label"; // plasmic-import: C6Kub6r1yktb/component
...
import Description from "../../Description"; // plasmic-import: x-Slhet5pQzM/component
import MenuPopover from "../../MenuPopover"; // plasmic-import: kd7ahv1K0Lgk/component
import MenuItem from "../../MenuItem"; // plasmic-import: uOXSGjdx3eNE/component
import MenuSection from "../../MenuSection"; // plasmic-import: PTJWV9SkSLGx/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: l7QAGd-ZHRah/css
...
function PlasmicCombobox__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div className={classNames(projectcss.all, sty.freeBox__zvh6Q)}>
        {(() => {
          const child$Props = {
        ...
        >
          <div className={classNames(projectcss.all, sty.freeBox__x8Nh8)}>
            <ChevronDownIcon
